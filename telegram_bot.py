...
# 24 HORAS HACIA ATRÁS
desde_utc = ahora_utc - timedelta(hours=24)

# FORMATO PARA NEWSAPI
from_date = desde_utc.strftime("%Y-%m-%dT%H:%M:%SZ")
to_date = ahora_utc.strftime("%Y-%m-%dT%H:%M:%SZ")
...
# OBTENER NOTICIAS ÚLTIMAS 24 HORAS
url_news = (
